...
const defaultConfig: AppConfig = {
  title: "Lumen Ads - Ad Room",
  description: "Thanks for stopping by! We are excited to learn more about your business. You are chatting with our virtual assistant, Amara—feel free to ask any questions! Just a heads-up: Amara is still in the alpha phase and continuously learning, so some responses might not be perfectly accurate. If you would like, you can schedule a call through our website, and we will be happy to connect!",
  video_fit: "cover",
  settings: {
    editable: true,
    theme_color: "amber",
